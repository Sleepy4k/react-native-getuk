...
import { faLocationCrosshairs, faLocationDot, faSignOut } from '@fortawesome/free-solid-svg-icons';
import {
  Text,
  View,
  ScrollView,
        ...
        <View style={styles.content}>
          ...
          {stores && stores.map((store, index) => (
            <View key={index} style={styles.card2}>
              <TouchableOpacity onPress={() => navigation.navigate('UserDetail', { param: { store: store } })}>
                <View style={{flexDirection: 'row'}}>
